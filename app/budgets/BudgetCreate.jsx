...
import { createBudget, fetchAvailableBudgets, resetState } from './BudgetActions';
...
export class BudgetCreate extends Component {
    ...
    componentWillReceiveProps(props) {
        if (props.visible && !props.seasonsFetched) {
            this.props.fetchAvailableBudgets();
        }
    }
...
BudgetCreate.propTypes = {
    ...
    fetchAvailableBudgets: PropTypes.func.isRequired,
...
function mapDispatchToProps(dispatch) {
    return bindActionCreators({ fetchAvailableBudgets, createBudget, resetState }, dispatch);
}
